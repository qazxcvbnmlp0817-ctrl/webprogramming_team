...
public class MainController {
    ...
    public String index(Model model) {
        ...
        model.addAttribute("notices", List.of(
            new NoticeDto(1L, "2025년 1학기 수강신청 일정 안내", "2025-05-08", "학과사무실", "학사", 0, false),
            new NoticeDto(2L, "졸업논문 제출 마감 안내",         "2025-05-06", "학과사무실", "학사", 0, false),
            new NoticeDto(3L, "장학금 신청 안내 (5월 15일까지)", "2025-05-04", "학생처",     "장학", 0, false),
            new NoticeDto(4L, "실험실 안전교육 일정 공지",       "2025-05-02", "학과사무실", "학사", 0, false),
            new NoticeDto(5L, "2025 산학협력 세미나 개최 안내",  "2025-04-30", "학과사무실", "행사", 0, false)
        ));
