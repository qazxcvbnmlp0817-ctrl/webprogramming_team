...
public class NoticeDto {
    ...
    public NoticeDto(Long id, String title, String date, String author,
        ...
        this(id, title, date, author, category, viewCount, featured,
             List.of(1, 2, 3, 4), null, null, null, 0, false, null, null, false);
    }

    public NoticeDto(Long id, String title, String date, String author,
                     String category, int viewCount, boolean featured, List<Integer> targetGrades) {
        this(id, title, date, author, category, viewCount, featured,
             targetGrades, null, null, null, 0, false, null, null, false);
    }
    ...
    public NoticeDto(Long id, String title, String date, String author,
        ...
        this(id, title, date, author, category, viewCount, featured,
             targetGrades, content, attachments, authorUsername, 0, false, null, null, false);
    }
    ...
    public NoticeDto(Long id, String title, String date, String author,
        ...
        this(id, title, date, author, category, viewCount, featured,
             targetGrades, content, attachments, authorUsername, commentCount, false, null, null, false);
    }
    ...
    public NoticeDto(Long id, String title, String date, String author,
        ...
        this(id, title, date, author, category, viewCount, featured,
             targetGrades, content, attachments, authorUsername, commentCount,
             isPublicToOutsiders, scopeType, scopeId, false);
    }
    ...
    public NoticeDto(Long id, String title, String date, String author,
                     ...
                     List<Integer> targetGrades, String content,
                     List<PostAttachmentDto> attachments, String authorUsername, int commentCount,
                     boolean isPublicToOutsiders, String scopeType, Long scopeId, boolean hidden) {
        this.id = id;
        this.title = title;
        this.date = date;
        this.author = author;
