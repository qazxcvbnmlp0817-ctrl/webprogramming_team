...
- [x] **Step 3: SchoolAdminController.java 수정**
...
- [x] **Step 3: handleInlineRoleChange 함수 추가**
...
- [x] **Step 4: "전체 사용자" 탭 테이블 헤더에 컬럼 추가**
...
- [x] **Step 5: "전체 사용자" 탭 각 행에 드롭다운 셀 추가**
