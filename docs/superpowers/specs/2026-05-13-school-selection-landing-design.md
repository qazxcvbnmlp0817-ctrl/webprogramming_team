...
각 SchoolDto는 FacultyDto 리스트를 포함하고, 각 FacultyDto는 DeptSelectionDto 리스트를 포함한다 (중첩 구조).

| 단과대학 (id) | 학부 (id) | 학과 목록 |
|---|---|---|
| 공과대학 (1) | 정보통신공학부 (1) | 컴퓨터공학과, 전기전자공학과, 정보통신공학과 |
| 공과대학 (1) | 기계시스템공학부 (2) | 기계공학과, 토목환경공학과 |
| 인문대학 (2) | 인문학부 (3) | 국어국문학과, 영어영문학과, 사학과 |
| 사회과학대학 (3) | 사회과학부 (4) | 행정학과, 경제학과, 사회학과 |
| 자연과학대학 (4) | 자연과학부 (5) | 수학과, 물리학과, 화학과 |
| 사범대학 (5) | 사범학부 (6) | 교육학과, 수학교육과 |
| 해양수산대학 (6) | 해양수산부 (7) | 해양시스템공학과, 수산생명과학과 |
